    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-200 py-12 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white border border-gray-800 rounded-md shadow-lg p-8">
          <h1 className="text-2xl font-semibold text-gray-800 mb-6">Login to ContactSync</h1>

          {error && (
            <div className="text-red-700 bg-gray-300 px-3 py-2 mb-4 rounded">{error}</div>
          )}
          ...
          <div className="space-y-3">
            <button
              type="button"
              onClick={() => { /* placeholder for Google OAuth */ }}
            ...
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.64 12.205c0-.8-.072-1.568-.208-2.31H12v4.376h6.44c-.277 1.494-1.133 2.76-2.415 3.605v2.998h3.897c2.286-2.103 3.58-5.196 3.58-8.669z" fill="#4285F4"/>
                <path d="M12 24c3.24 0 5.958-1.07 7.944-2.906l-3.897-2.997c-1.082.726-2.467 1.156-4.047 1.156-3.106 0-5.74-2.096-6.686-4.913H1.27v3.086C3.24 21.803 7.36 24 12 24z" fill="#34A853"/>
                <path d="M5.314 14.34a7.238 7.238 0 010-4.68V6.574H1.27a12 12 0 000 10.852l4.044-3.085z" fill="#FBBC05"/>
                <path d="M12 4.77c1.758 0 3.345.605 4.592 1.796l3.44-3.44C17.954 1.262 15.236 0 12 0 7.36 0 3.24 2.197 1.27 5.574l4.044 3.086C6.26 6.865 8.894 4.77 12 4.77z" fill="#EA4335"/>
              </svg>
